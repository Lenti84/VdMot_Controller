...
#warning changed OneWireLib - use of open drain output for STM32 instead of push-pull, see https://github.com/Lenti84/VdMot_Controller/issues/37
//#define DIRECT_MODE_OUTPUT(base, pin)   pin_function((PinName)pin, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0))
#define DIRECT_MODE_OUTPUT(base, pin)   pin_function((PinName)pin, STM_PIN_DATA(STM_MODE_OUTPUT_OD, GPIO_NOPULL, 0))
